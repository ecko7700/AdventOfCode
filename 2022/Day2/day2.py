...
stratList = loadData(filePath)
#stratList = loadData(filePath='unitTestData.txt')

def calcStrat(stratList):
    aDict = {'A':1, 'B' : 2, 'C' : 3}
    xDict = {'X' : 'Rock', 'Y' : 'Paper', 'Z' : 'Scissors'}
    scoreDict = {'Lost' : 0, 'Draw' : 3, 'Win' : 6}
    totalScore = 0

    for scores in stratList:
        tempScore = 0
        if scores[0] == 'A' and scores[2] == 'X':
            tempScore = 1 + 3
        elif scores[0] == 'B' and scores[2] == 'X':
            tempScore = 1 + 0
        elif scores[0] == 'C' and scores[2] == 'X':
            tempScore = 1 + 6
        elif scores[0] == 'A' and scores[2] == 'Y':
            tempScore = 2 + 6
        elif scores[0] == 'B' and scores[2] == 'Y':
            tempScore = 2 + 3
        elif scores[0] == 'C' and scores[2] == 'Y':
            tempScore = 2 + 0
        elif scores[0] == 'A' and scores[2] == 'Z':
            tempScore = 3 + 0
        elif scores[0] == 'B' and scores[2] == 'Z':
            tempScore = 3 + 6
        elif scores[0] == 'C' and scores[2] == 'Z':
            tempScore = 3 + 3
...
def calcStratPart2(stratList):
    aDict = {'A':1, 'B' : 2, 'C' : 3}
    xDict = {'X' : 'Lose', 'Y' : 'Draw', 'Z' : 'Win'}
    scoreDict = {'Lost' : 0, 'Draw' : 3, 'Win' : 6}
    totalScore = 0
    l1 =['A = Rock = 1',
    'B = Paper = 2',
...
stratList2 = loadData('data.txt')
print(calcStratPart2(stratList2))